...
class WXPay {
  constructor({appid, mchid, partnerKey, pfx, notify_url, refund_url, spbill_create_ip, sandbox} = {}, debug = false) {
    ...
    const domain = `https://api.mch.weixin.qq.com${sandbox ? '/sandboxnew' : ''}`;
    this.urls = {
      micropay: `${domain}/pay/micropay`,
      reverse: `${domain}/secapi/pay/reverse`,
      unifiedorder: `${domain}/pay/unifiedorder`,
      orderquery: `${domain}/pay/orderquery`,
      closeorder: `${domain}/pay/closeorder`,
      refund: `${domain}/secapi/pay/refund`,
      refundquery: `${domain}/pay/refundquery`,
      downloadbill: `${domain}/pay/downloadbill`,
      downloadfundflow: `${domain}/pay/downloadfundflow`,
      send_coupon: `${domain}/mmpaymkttransfers/send_coupon`,
      query_coupon_stock: `${domain}/mmpaymkttransfers/query_coupon_stock`,
      querycouponsinfo: `${domain}/mmpaymkttransfers/querycouponsinfo`,
      transfers: `${domain}/mmpaymkttransfers/promotion/transfers`,
      gettransferinfo: `${domain}/mmpaymkttransfers/gettransferinfo`,
      sendredpack: `${domain}/mmpaymkttransfers/sendredpack`,
      sendgroupredpack: `${domain}/mmpaymkttransfers/sendgroupredpack`,
      gethbinfo: `${domain}/mmpaymkttransfers/gethbinfo`,
      paybank: `${domain}/mmpaysptrans/pay_bank`,
      querybank: `${domain}/mmpaysptrans/query_bank`,
      getpublickey: `${domain}/risk/getpublickey`,
      getsignkey: `${domain}/sandboxnew/pay/getsignkey`,
      combinedorder: `${domain}/pay/combinedorder`
    };
    this.debug = debug;
  }
  ...
  static async sandbox(config, debug) {
    let {sandbox_signkey} = await WXPay.init(config).getSignkey();
    return new WXPay({
      ...config,
